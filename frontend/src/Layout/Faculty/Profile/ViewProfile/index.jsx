                  ...
                  <Form>
                    <Row className='mb-4'>
                      <Col sm='12' className='d-flex justify-content-center align-items-center flex-column'>
                        ...
                        <div className='mt-3'>
                          <Link to={`${process.env.PUBLIC_URL}/faculty/viewprofile`} className='text-dark'>
                    ...
                    <div className="row m-3">
                      <Col xl='4'>
                        ...
                        <FormGroup className='mb-4'>
                          <H6 attrH6={{ className: 'form-label fw-bold' }}>Faculty ID</H6>
                          <P className="text-muted">{facultyData.facultyId}</P>
                        </FormGroup>
                      </Col>
                      <Col xl='4'>
                        <FormGroup className='mb-4'>
                        ...
                        <FormGroup className='mb-4'>
                          ...
                          <P className="text-muted">{facultyData.phoneNo}</P>
                        </FormGroup>
                      </Col>
                      <Col xl='4'>
                        <FormGroup className='mb-4'>
                        ...
                        <FormGroup className='mb-4'>
                          <Label className='form-label fw-bold'>Academic Experience</Label>
                          <P className="text-muted">{facultyData.academicexp}</P>
                        </FormGroup>
                      </Col>
                    </div>
                  </Form>
