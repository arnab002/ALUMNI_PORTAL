...
const EditMaterial = ({material , onClose}) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                if (materialData.department && materialData.semester) {
                    const response = await axios.post(`${baseApiURL()}/getFilteredSubjectDetails`, { deptname: materialData.department, semester: materialData.semester });
        ...
        fetchData();
    }, [materialData.department, materialData.semester]);

    useEffect(() => {
        const fetchMaterialDetails = async () => {
          try {
            const response = await axios.get(`${baseApiURL()}/getSingleMaterialDetails/${material._id}`);
    ...
    useEffect(() => {
        if (isDataChanged) {
          ...
          axios.post(`${baseApiURL()}/editMaterialDetails/${material._id}`, formData, {
            headers: {
