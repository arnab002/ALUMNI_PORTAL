...
import { Row, Form, Input, Col, Card, CardHeader, Table, Modal, ModalBody, Pagination, PaginationItem, PaginationLink } from "reactstrap";
        ...
        const fetchData = async () => {
            try {
                if (department && selectedSemester) {
                    const response = await axios.post(`${baseApiURL()}/getFilteredSubjectDetails`, { deptname: department, semester: selectedSemester });
                    ...
                    <div className={`card-block row ${isMobile ? 'flex-column' : 'flex-row'}`}>
                        <Col sm="12" lg="12" xl="12">
                            ...
                            <Row className='d-flex justify-content-center'>
                                ...
                                <Col sm="12" xl="3">
                                    <Form className='theme-form'>
                                        <Input type="select" className="form-control digits" name="subject" value={selectedSubject} onChange={handleSubjectChange} disabled={!department || !selectedSemester}>
                                ...
                                <Col sm="12" xl="3">
                                    <Form className='theme-form'>
                                        <Input type="search" name="select" className="form-control digits" placeholder='Search Materials....' value={searchValue} onChange={handleSearchChange} />
                                    </Form>
                                </Col>
                            </Row>
                            <br /><br />
