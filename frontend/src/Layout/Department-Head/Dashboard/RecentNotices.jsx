      ...
      try {
        const response = await axios.get(`${baseApiURL()}/getnewnoticedetails`, {
          params: {
            ...
            type: ['Department-Head Notice Panel', 'Faculty Notice Panel', 'Student Notice Panel']
          },
        });
      ...
      <CardHeader className='card-no-border'>
        <div className='header-top'>
          ...
          <div className='card-header-right-icon'>
            <Btn attrBtn={{ color: 'light-primary', className: 'btn badge-light-primary' }}><Link to="/department/notice">View All Notices</Link></Btn>
          </div>
        </div>
      </CardHeader>
