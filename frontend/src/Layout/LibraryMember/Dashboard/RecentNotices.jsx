    ...
    <Card className='schedule-card'>
      <CardHeader className='card-no-border'>
        <div className='header-top'>
          <H5 attrH5={{ className: 'm-0' }}>Recent Library Notices</H5>
          <div className='card-header-right-icon'>
            <Btn attrBtn={{ color: 'light-primary', className: 'btn badge-light-primary' }}><Link to="/library/member/notices">View All Notices</Link></Btn>
          </div>
        </div> 
      </CardHeader>
